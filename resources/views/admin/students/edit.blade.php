...
@section('content')
    <div class="p-4 sm:ml-64 mt-14">
        <div class="p-4 border-2 border-default border-dashed rounded-base">
            <h2 class="mb-4 text-xl font-bold text-gray-900">Editar estudiante</h2>
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="matricula" id="brand"
                            ...
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                            placeholder="Escribe la matricula" required="">
                        @error('matricula')
                            <p class="text-red-700 p-2">{{$message}}</p> 
                        @enderror
                    </div>
                    <div class="w-full">
                        ...
                        <input type="text" name="phone" id="price"
                            value="{{old('phone', $student->profile->phone)}}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                    ...
                    <div>
                        ...
                        <input type="text" name="address" id="price"
                            value="{{old('address', $student->profile->address)}}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
